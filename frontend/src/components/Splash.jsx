  ...
  <div className="splash">
    <section className="splash-top">
      <section className="splash-header">
        <div className="splash-header-left">
          ...
          <div className="splash-header-left-dropdown"></div>
        </div>

        <div className="splash-header-right">
          <div className="splash-header-search-bar"></div>
    ...
    <section className="splash-body">
      <section className="splash-body-one">
        <div className="splash-body-one-one">
          ...
          <div className="splash-body-one-one-body-container">
            <div className="splash-body-one-one-body">Persistence is key!</div>
        ...
        <div className="splash-body-one-two">
          <div className="splash-body-one-two-title-container">
            <div className="splash-body-one-two-title-bold">get your voice</div>
          ...
          <div className="splash-body-one-two-body-container">
            ...
            <div className="splash-body-one-two-body">
              We can tell you who is in charge of making the changes that matter
              most to you.
            </div>
          </div>
        </div>
      ...
      <section className="splash-body-two">
        ...
        <div className="splash-body-politician-show-explanation">
          ...
          <div className="splash-body-politician-show-description-body">
            Check to see how long they've been in office, when they're up for
            re-election, voting history, adn recent news.
          </div>
          <div className="splash-body-politician-show-description-body">
            save and watch your representatives to stay up to date on how they
            treat your issues.
          </div>
        </div>
      </section>
      ...
      <section className="splash-source-information">
        <div className="open-source-header">This project is open source</div>
