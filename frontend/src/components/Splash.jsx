  ...
  <div className="splash">
    ...
    <section className="splash-body">
      <section className="splash-body-one">
        <div className="splash-body-one-one"></div>
      ...
      <section className="splash-body-two">
        <div className="splash-body-politician-show"></div>
        <div className="splash-body-politician-show-explanation"></div>
      </section>

      <section className="splash-source-information">
        <div className="open-source-header"></div>
        <div className="github-repo-info"></div>
